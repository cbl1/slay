...
// 继承CustomPlayer类
public class Alter extends CustomPlayer {
    // 火堆的人物立绘（行动前）
    private static final String MY_CHARACTER_SHOULDER_1 = "ExampleModResources/img/alter/shoulder1.png";
    // 火堆的人物立绘（行动后）
    private static final String MY_CHARACTER_SHOULDER_2 = "ExampleModResources/img/alter/shoulder2.png";
    // 人物死亡图像
    private static final String CORPSE_IMAGE = "ExampleModResources/img/alter/corpse.png";
    // 战斗界面左下角能量图标的每个图层
    ...
    private static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString("ExampleMod:Alter");

    public Alter(String name) {
        super(name, MY_CHARACTER2,ORB_TEXTURES,"ExampleModResources/img/UI/orb/vfx.png", LAYER_SPEED, null, null);
        ...
        this.initializeClass(
                "ExampleModResources/img/alter/character.png", // 人物图片
    ...
    public List<CutscenePanel> getCutscenePanels() {
        ...
        panels.add(new CutscenePanel("ExampleModResources/img/alter/Victory1.png", "ATTACK_MAGIC_FAST_1"));
        panels.add(new CutscenePanel("ExampleModResources/img/alter/Victory2.png"));
        panels.add(new CutscenePanel("ExampleModResources/img/alter/Victory3.png"));
        return panels;
    }
    ...
    public static class PlayerColorEnum {
        ...
        @SpireEnum
        public static PlayerClass MY_CHARACTER2;

        // ***将CardColor和LibraryType的变量名改为你的角色的颜色名称，确保不会与其他mod冲突***
        // ***并且名称需要一致！***
        @SpireEnum
        public static AbstractCard.CardColor Alter_Red;
    }
    ...
    public static class PlayerLibraryEnum {
        ...
        // 这个变量未被使用（呈现灰色）是正常的
        @SpireEnum
        public static CardLibrary.LibraryType Alter_Red;
    }
}
